...
public class ThriftCLIServiceClient extends CLIServiceClient {
  ...
  public static final Logger LOG = LoggerFactory.getLogger(ThriftCLIServiceClient.class.getName());
  ...
  public SessionHandle openSession(String username, String password,
    ...
    try {
      ...
      LOG.info("tien comment user: " + username);
      LOG.info("tien comment password: " + password);
      LOG.info("tien comment configuration: " + configuration);
